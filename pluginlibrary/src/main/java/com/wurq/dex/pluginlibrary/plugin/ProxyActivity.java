 ...
 */
public class ProxyActivity  extends Activity implements AttachImp {

    protected PluginImp mRemoteActivity;
    private ProxyImp impl = new ProxyImp(this);
    ...
    @Override
    public void attach(PluginImp remoteActivity, PluginManager pluginManager) {
